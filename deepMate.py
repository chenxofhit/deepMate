...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description='deepMate',
        formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    parser.add_argument('dataset', default='biase', )
    ...
    x,y = load_data(args.dataset, verbose = 1) 

    shape = [x.shape[-1], 1024, 512, 64, args.n_clusters]
    ...
    np.savetxt(args.save_dir+"/"+args.dataset+'-clusters.txt',
               clusters, fmt='%i', delimiter=',')